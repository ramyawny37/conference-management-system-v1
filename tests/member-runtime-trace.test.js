...
const coreAssetMarker='conference-state-invariants-v1';
...
const shellMarker='production-3-6-0-conference-state-invariants-v1';
...
const scriptMarker='conference-state-invariants-v1';
