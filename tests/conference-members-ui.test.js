...
async function run(){
  ...
  assert.ok(
    /const\s+CACHE_REVISION\s*=\s*IS_DEVELOPMENT\s*\?\s*['"]development-3-4-0-adjustment-conversion-ux-v1['"]\s*:\s*['"]production-3-4-0-platform-owner-administration-context-v1['"]\s*;/
