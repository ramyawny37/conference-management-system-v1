...
test('Reservations global navigation and static bundle stay inside the unified Platform artifact',()=>{
  ...
  assert.match(index,/modules\/reservations\/reservations-module\.js\?rev=participant-edit-hero-v1/);
  assert.match(index,/modules\/reservations\/reservations-module\.css\?rev=participant-quick-actions-v1/);
  assert.match(worker,/\.\/modules\/reservations\/reservations-module\.js\?rev=participant-edit-hero-v1/);
