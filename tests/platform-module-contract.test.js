...
test('Reservations global navigation and static bundle stay inside the unified Platform artifact',()=>{
  ...
  assert.match(index,/modules\/reservations\/reservations-module\.js\?rev=reservations-readiness-aware-kpis-v1/);
  assert.match(index,/modules\/reservations\/reservations-module\.css\?rev=reservations-readiness-aware-kpis-v1/);
  assert.match(worker,/\.\/modules\/reservations\/reservations-module\.js\?rev=reservations-readiness-aware-kpis-v1/);
  assert.match(worker,/\.\/modules\/reservations\/reservations-module\.css\?rev=reservations-readiness-aware-kpis-v1/);
