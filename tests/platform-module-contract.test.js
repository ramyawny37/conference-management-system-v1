...
test('Reservations global navigation and static bundle stay inside the unified Platform artifact',()=>{
  ...
  assert.match(index,/modules\/reservations\/reservations-module\.js\?rev=reservations-workspace-v4/);
  assert.match(index,/modules\/reservations\/reservations-module\.css\?rev=reservations-workspace-v4/);
  assert.match(worker,/\.\/modules\/reservations\/reservations-module\.js\?rev=reservations-workspace-v4/);
  assert.match(worker,/\.\/modules\/reservations\/reservations-module\.css\?rev=reservations-workspace-v4/);
