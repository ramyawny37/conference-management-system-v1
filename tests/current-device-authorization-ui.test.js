...
(async function(){
  ...
  assert.strictEqual(cacheRevision[1],'reservations-participant-quick-actions-v1');
  assert.strictEqual(cacheRevision[2],'production-3-6-0-release-v5');
