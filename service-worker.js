...
const CACHE_REVISION = IS_DEVELOPMENT
  ...
  : 'production-3-6-0-platform-handoff-cache-v1';
...
const CORE_ASSETS = [
  ...
  './modules/reservations/reservations-module.css?rev=reservations-reference-locked-reconstruction-v5',
  ...
  './js/supabase/device-session.js?rev=auth-bound-edge-session-v1',
  './js/supabase/conference-device-operation-contract.js?rev=generic-permission-resources-v1',
  ...
  './js/supabase/client.js?rev=target-device-argument-preservation-v1',
  './js/supabase/auth.js?rev=account-session-identity-v1',
  './js/platform-integration.js?rev=canonical-platform-foundation-v1',
  './modules/reservations/reservations-module.js?rev=reservations-reference-locked-reconstruction-v5',
  ...
  './js/sync/device-authorization-administration-ui.js?rev=startup-device-admin-lifecycle-v2',
