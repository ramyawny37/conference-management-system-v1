...
const CACHE_REVISION = IS_DEVELOPMENT
  ? 'reservations-prototype-fidelity-cache-v2'
...
const CORE_ASSETS = [
  ...
  './canonical-platform-shell.css?rev=reservations-navigation-v1',
  './modules/reservations/reservations-module.css?rev=reservations-internal-modernization-v1',
  ...
  './modules/reservations/reservations-module.js?rev=reservations-internal-modernization-v1',
