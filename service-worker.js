...
const CACHE_REVISION = IS_DEVELOPMENT
  ? 'reservations-operational-structure-v1'
...
const CORE_ASSETS = [
  ...
  './modules/reservations/reservations-module.css?rev=reservations-operational-structure-v1',
  ...
  './modules/reservations/reservations-module.js?rev=reservations-operational-structure-v1',
