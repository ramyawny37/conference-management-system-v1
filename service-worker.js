...
const CACHE_REVISION = IS_DEVELOPMENT
  ? 'reservations-participant-quick-actions-v1'
...
const CORE_ASSETS = [
  ...
  './modules/reservations/reservations-module.css?rev=participant-quick-actions-v1',
  ...
  './modules/reservations/reservations-module.js?rev=participant-quick-actions-v1',
