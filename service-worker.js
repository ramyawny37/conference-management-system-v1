...
const CACHE_REVISION = IS_DEVELOPMENT
  ? 'reservations-event-mutation-integrity-v1'
...
const CORE_ASSETS = [
  ...
  './modules/reservations/reservations-module.css?rev=reservations-event-mutation-integrity-v1',
  ...
  './modules/reservations/reservations-module.js?rev=reservations-event-mutation-integrity-v1',
