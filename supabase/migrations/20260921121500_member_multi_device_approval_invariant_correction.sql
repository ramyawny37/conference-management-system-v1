-- Forward-only correction of the canonical member-device approval contract.
-- The canonical 20260920221928 migration accidentally retained a legacy
-- single-approved-device invariant. Approval is additive; explicit replacement
-- remains a separate operation. No device rows are backfilled or reclassified.
