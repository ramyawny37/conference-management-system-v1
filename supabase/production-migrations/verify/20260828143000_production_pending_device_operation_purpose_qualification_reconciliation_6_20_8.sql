-- Independent read-only resulting-contract verifier for 20260828143000.
select case when exists(select 1 from supabase_migrations.schema_migrations
    where version='20260828143000' and name='production_pending_device_operation_purpose_qualification_reconciliation_6_20_8') and ((select count(*)=1 and bool_and(p.prosecdef)
