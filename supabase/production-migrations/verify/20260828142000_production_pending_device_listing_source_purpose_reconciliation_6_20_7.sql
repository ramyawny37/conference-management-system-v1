-- Independent read-only resulting-contract verifier for 20260828142000.
select case when exists(select 1 from supabase_migrations.schema_migrations
    where version='20260828142000' and name='production_pending_device_listing_source_purpose_reconciliation_6_20_7') and ((select count(*)=1 and bool_and(p.prosecdef)
