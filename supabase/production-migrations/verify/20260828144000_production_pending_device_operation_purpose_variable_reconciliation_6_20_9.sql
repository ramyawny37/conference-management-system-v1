-- Independent read-only resulting-contract verifier for 20260828144000.
select case when exists(select 1 from supabase_migrations.schema_migrations
    where version='20260828144000' and name='production_pending_device_operation_purpose_variable_reconciliation_6_20_9') and ((select count(*)=1 and bool_and(p.prosecdef)
